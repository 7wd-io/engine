...
func TestStateFromV2(t *testing.T) {
	type args struct {
		m []Mutator
	}
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				m: []Mutator{
					...
					NewMovePickWonder(TheGreatLighthouse),
					NewMovePickWonder(StatueOfLiberty),
					NewMovePickWonder(CircusMaximus),
					NewMovePickWonder(Piraeus),
					...
					NewMoveDiscardCard(Palisade),
					NewMoveDiscardCard(Garrison),
					NewMoveConstructCard(StoneReserve),
					NewMoveConstructCard(Pharmacist),
					NewMoveConstructCard(GuardTower),
					NewMoveConstructCard(Quarry),
					NewMoveConstructCard(Baths),
					NewMoveConstructCard(Apothecary),
					NewMoveConstructCard(ClayPit),
					NewMoveDiscardCard(Stable),
					NewMoveConstructCard(Altar),
					NewMoveConstructCard(ClayReserve),
					NewMoveConstructCard(LoggingCamp),

					NewMoveSelectWhoBeginsTheNextAge("user2"),
					NewMoveConstructCard(Dispensary),
					NewMovePickBoardToken(Economy),
					NewMoveDiscardCard(ShelfQuarry),
					...
					NewMoveDiscardCard(BrickYard),
					NewMoveDiscardCard(HorseBreeders),
					NewMoveConstructCard(Aqueduct),
					NewMoveConstructCard(Library),
					NewMovePickBoardToken(Urbanism),
					NewMoveConstructWonder(TheGreatLighthouse, GlassBlower),
					NewMoveConstructCard(ParadeGround),
					NewMoveConstructCard(Statue),
					NewMoveConstructWonder(CircusMaximus, CourtHouse),
					NewMoveBurnCard(GlassWorks),
					NewMoveDiscardCard(Barracks),
					NewMoveConstructCard(Laboratory),
					NewMoveConstructWonder(Piraeus, Rostrum),
					NewMoveConstructCard(Forum),
					NewMoveDiscardCard(SawMill),

					NewMoveSelectWhoBeginsTheNextAge("user1"),
					NewMoveConstructCard(Circus),
					NewMoveConstructCard(Observatory),
					NewMoveConstructWonder(StatueOfLiberty, Arsenal),
					NewMovePickReturnedCards(Senate, Arena),
					NewMoveDiscardCard(Fortifications),
					NewMoveConstructCard(ShipOwnersGuild),
					NewMoveConstructWonder(TheSphinx, Pantheon),
					NewMoveConstructCard(TownHall),
					NewMoveConstructCard(Gardens),
					NewMoveConstructWonder(TheTempleOfArtemis, Armory),
					NewMoveConstructWonder(TheHangingGardens, SiegeWorkshop),
					NewMoveConstructCard(MagistratesGuild),
					NewMoveConstructCard(Study),
					NewMoveConstructCard(Palace),
					...
					NewMoveConstructCard(Pretorium),
					NewMoveConstructCard(Lighthouse),
					NewMoveConstructCard(Obelisk),
					NewMoveDiscardCard(University),
				},
			},
			want:    nil,
			wantErr: false,
